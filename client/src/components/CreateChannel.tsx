...
const CreateChannel = (createChannelView: { createChannelView: boolean }) => {
  ...
  return (
    <div
      className={`transition-all absolute top-0 left-0 w-full h-full flex items-center justify-center backdrop-blur-md`}
    >
      <div className="custom-transition shadow-2xl z-10 p-4 pr-8 w-[60vw] md:w-[70vw] lg:w-[60vw] xl:w-[50vw] max-w-[40rem] min-h-[20rem] max-h-[24rem] rounded-xl flex bg-opacity-90 bg-white dark:bg-[hsl(var(--background))]">
          ...
          <div className="w-full">
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-3 mt-4 w-2/4">
                ...
                <Button className="rounded-full" onClick={createChannelHandler}>
                  Save
                </Button>
              </div>
            </div>
